"""
This File was migrated from the old project, and is intended for reference only

PLEASE DO NOT USE THIS FILE FOR ANY ACTUAL WORK
THINGS WILL BREAK
...
async def loginUsername(server: str, username: str, password: str) -> Literal['Success', 'BadCredentials', 'UnknownError', 'InvalidCredentials', 'InvalidUrl']:
    server.strip('/')
